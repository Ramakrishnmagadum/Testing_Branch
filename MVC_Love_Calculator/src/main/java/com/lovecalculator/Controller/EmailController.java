...
import com.lovecalculator.service.LCAppEmailServiceImpl;

@Controller
public class EmailController {
	
@Autowired
LCAppEmailServiceImpl emailservice;
...
//	----------------------------------------------------- BY Session Management By HttpSession --------------------------------------------------------------------
	@RequestMapping("/sendemail")
	public String getEmailPage(@ModelAttribute("Email") EmailDTO emailDTO, Model model, HttpSession session) {
...
//		in process-email --> directly from session getting values ...
	...
	public String processEmail(@ModelAttribute("email") EmailDTO emailDTO, Model model, HttpSession session) {
		
		String messsage =session.getAttribute("message").toString();
		
		emailservice.sendEmail(session.getAttribute("username").toString()   ,  emailDTO.getUseremail(),  messsage);
