...
<!-- If Cookies are disabled then this line will add Sessionid with path --so it will be easy to track... -->
<c:url var="formUrl" value="/process-email" />
