...
@Controller
//this  annotation :-@ControllerAdvice applies to all controllers in your application.The @ModelAttribute-annotated method runs before every request handled by any controller.
//The attributes added are available in every view rendered by the application.
@ControllerAdvice(assignableTypes = {MywebsiteController.class})

//@ControllerAdvice(assignableTypes = {MywebsiteController.class})   ----> this will apply only On this Controller.....
//@ControllerAdvice(basePackages= {"com.ModelAttribute.Controller"})   ---> this will apply only for this BasePackages....
